        ...
        <div class="row top-bar">
            ...
            <div class="col-lg-6 col-md-6 right-part">
                <ul>
                    ...
                    <li>
                     <a target='_blank' style='border-radius: 19px;height: 38px;'href='https://xalop.com/on/p/18/all-services2222' class='btn btn-success'>Other Tools</a></li>
                </ul>
            </div>
        </div>
    </div>
...
<?php /**PATH /home/dvjxg9j1xkts/public_html/dashboard.drjitendrakodilkar.com/resources/views/custom_landing_page/custome-top-header-section.blade.php ENDPATH**/ ?>