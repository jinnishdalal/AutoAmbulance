    ...
    <div class="container bottom-part" id="footer_bottom">
        <div class="row">
            ...
            <div class='col-lg-2 col-md-2'>
                 <a target='_blank' style='border-radius: 19px;height: 38px;'href='https://xalop.com/on/p/18/all-services2222' class='btn btn-success'>Other Tools</a>
            </div>
            <div class="col-lg-4 col-md-4 inner-text">
                <ul id="data">
...
<?php /**PATH /home/dvjxg9j1xkts/public_html/dashboard.drjitendrakodilkar.com/resources/views/custom_landing_page/custome-footer-section.blade.php ENDPATH**/ ?>