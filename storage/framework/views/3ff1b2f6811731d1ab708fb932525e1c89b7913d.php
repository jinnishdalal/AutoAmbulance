                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e(\App\Utility::invoiceNumberFormat($invoice->invoice_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Project')); ?>:</td>
                                                <td><?php echo e($invoice->project ? $invoice->project->name : '-'); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Utility::dateFormat($invoice->issue_date)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Due Date')); ?>:</td>
                                                <td><?php echo e(\App\Utility::dateFormat($invoice->due_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                ...
                                                <div class="d-table-th w-18"><?php echo e(__('Item')); ?></div>
                                                ...
                                                <?php if(isset($invoice->items) && count($invoice->items) > 0): ?>
                                                    <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($border_color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-18">
                                                                <span data-v-f2a183a6=""><?php echo e($item->iteam); ?></span>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <span data-v-f2a183a6=""><?php echo e($usr->priceFormat($item->price)); ?></span>
                                                            </div>
                                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($invoice->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($invoice->discount): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($invoice->discount)); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if($invoice->getTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($invoice->getTax())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($invoice->getSubTotal()-$invoice->discount+$invoice->getTax())); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($invoice->getDue())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home1/xgjtsdo/work.xalop.com/resources/views/invoices/templates/template1.blade.php ENDPATH**/ ?>