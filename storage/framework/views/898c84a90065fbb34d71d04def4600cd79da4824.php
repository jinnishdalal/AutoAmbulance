                                        ...
                                        <?php if(in_array('change password '.$module,(array) $permissions)): ?>
                                            <?php if($key = array_search('change password '.$module,$permissions)): ?>
                                                <div class="col-md-3 custom-control custom-checkbox">
                                                    ...
                                                    <?php echo e(Form::label('permission'.$key,'Change Password',['class'=>'custom-control-label font-weight-500'])); ?><br>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
...
<?php /**PATH /home1/xgjtsdo/work.xalop.com/resources/views/role/create.blade.php ENDPATH**/ ?>