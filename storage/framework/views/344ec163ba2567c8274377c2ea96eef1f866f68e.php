<div class="card bg-none card-box">
    <?php echo e(Form::model($invoice, array('route' => array('invoices.update', $invoice->id), 'method' => 'PUT'))); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::text('due_date', null, array('class' => 'form-control datepicker','required'=>'required'))); ?>
...
<?php /**PATH /home1/xgjtsdo/work.xalop.com/resources/views/invoices/edit.blade.php ENDPATH**/ ?>