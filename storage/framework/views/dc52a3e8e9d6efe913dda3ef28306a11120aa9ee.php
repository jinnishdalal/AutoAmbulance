                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color: <?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        <div data-v-f2a183a6="" class="d-title"><?php echo e(__('ESTIMATION')); ?></div>
                                        <table data-v-f2a183a6="" class="summary-table">
                                            <tbody data-v-f2a183a6="">
                                            <tr>
                                                <td><?php echo e(__('Number')); ?>:</td>
                                                <td><?php echo e(\App\Utility::estimateNumberFormat($estimation->estimation_id)); ?></td>
                                            </tr>
                                            <tr>
                                                <td><?php echo e(__('Issue Date')); ?>:</td>
                                                <td><?php echo e(\App\Utility::dateFormat($estimation->issue_date)); ?></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color: <?php echo e($font_color); ?>">
                                                ...
                                                <div class="d-table-th w-7"><?php echo e(__('Item')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Price')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Quantity')); ?></div>
                                                <div class="d-table-th w-4 text-right"><?php echo e(__('Totals')); ?></div>
                                            </div>
                                            <div class="d-table-body">
                                                <?php if(isset($estimation->getProducts) && count($estimation->getProducts) > 0): ?>
                                                    <?php $__currentLoopData = $estimation->getProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($border_color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($usr->priceFormat($item->price)); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->quantity); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-4 text-right"><span><?php echo e($usr->priceFormat($item->price * $item->quantity)); ?></span></div>
                                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal())); ?></div>
                                                    </div>
                                                    <?php if($estimation->discount): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Discount')); ?>:</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->discount)); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if($estimation->getTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e($estimation->tax->name); ?> (<?php echo e($estimation->tax->rate); ?>%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getTax())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Total')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e($usr->priceFormat($estimation->getSubTotal()-$estimation->discount+$estimation->getTax())); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <b><?php echo e($settings['footer_title']); ?></b>
                                                <p><?php echo e($settings['footer_note']); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php if(!isset($preview)): ?>
    <?php echo $__env->make('estimations.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
<?php endif; ?>
</body>
</html>
<?php /**PATH /home1/xgjtsdo/work.xalop.com/resources/views/estimations/templates/template1.blade.php ENDPATH**/ ?>