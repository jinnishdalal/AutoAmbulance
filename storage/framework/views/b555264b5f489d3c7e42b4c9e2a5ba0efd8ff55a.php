<div class="card bg-none card-box">
    <?php echo e(Form::model($expense, array('route' => array('expenses.update', $expense->id), 'method' => 'PUT','enctype' => "multipart/form-data"))); ?>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <?php echo e(Form::select('project', $projects,null, array('class' => 'form-control select2','required'=>'required'))); ?>
...
<?php /**PATH /home1/xgjtsdo/work.xalop.com/resources/views/expenses/edit.blade.php ENDPATH**/ ?>