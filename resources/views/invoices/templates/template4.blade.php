                                ...
                                <div data-v-363339a0="" class="row">
                                    <div data-v-363339a0="" class="col-66">
                                        ...
                                        @if(isset($user) && !empty($user))
                                            <p data-v-363339a0="">{{$user->name}}</p>
                                            <pre data-v-363339a0="">{{$user->email}}</pre>
                                        @else
                                            <p data-v-363339a0="">-</p>
                                        @endif
                                    </div>
                                    <div data-v-363339a0="" class="col-33">
                                        <table data-v-363339a0="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('Due Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        <div data-v-363339a0="" class="tu d-table-tr" style="color: {{($color == '#ffffff') ? 'black': $color}}; border-bottom: 2px solid {{$color}}; border-top: 2px solid {{$color}};">
                                            ...
                                            <div data-v-363339a0="" class="d-table-th w-18">{{__('Item description')}}</div>
                                            <div data-v-363339a0="" class="d-table-th w-4">{{__('Price')}}</div>
                                        </div>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-363339a0="" class="d-table-tr">
                                                        ...
                                                        <div data-v-363339a0="" class="d-table-td w-18">
                                                            <pre data-v-363339a0="">{{$item->iteam}}<br data-v-363339a0=""></pre>
                                                        </div>
                                                        <div data-v-363339a0="" class="d-table-td w-4"><span data-v-363339a0="">{{$usr->priceFormat($item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-363339a0="" class="d-table-tr">
                                                    ...
                                                    <div data-v-363339a0="" class="d-table-td w-4"><span data-v-363339a0="">-</span></div>
                                                </div>
                                            @endif
                                        </div>
