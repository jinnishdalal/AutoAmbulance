                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            ...
                                            @if(isset($user) && !empty($user))
                                                <strong data-v-4b3dcb8a="" class="sub-title">{{$user->name}}</strong>
                                                <pre data-v-4b3dcb8a="">{{$user->email}}</pre>
                                            @else
                                                <strong data-v-4b3dcb8a="" class="sub-title">-</strong>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-33">
                                        <table data-v-4b3dcb8a="" class="summary-table">
                                            ...
                                            <tr data-v-4b3dcb8a="">
                                                ...
                                                <td data-v-4b3dcb8a="" class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-4b3dcb8a="">
                                                <td data-v-4b3dcb8a="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-4b3dcb8a="" class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-4b3dcb8a="" class="d-table">
                                    <div data-v-4b3dcb8a="" class="d-table">
                                        <div data-v-4b3dcb8a="" class="tu d-table-tr" style="background: {{$color}}; padding: 5px;color: {{$font_color}}">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-th w-18">{{__('Item description')}}</div>
                                            <div data-v-4b3dcb8a="" class="d-table-th w-4">{{__('Price')}}</div>
                                        </div>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-18">
                                                            <pre data-v-4b3dcb8a="">{{$item->iteam}}<br data-v-4b3dcb8a=""></pre>
                                                        </div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-4"><span data-v-4b3dcb8a="">{{$usr->priceFormat($item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-td w-4"><span data-v-4b3dcb8a="">-</span></div>
                                                </div>
                                            @endif
                                        </div>
