                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-3"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{($color == '#ffffff') ? 'black': $color}};">{{__('INVOICE')}}</h1>
                                        ...
                                        <p data-v-7d9d14b5="">{{\App\Utility::dateFormat($invoice->issue_date)}}</p>
                                    </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <div data-v-7d9d14b5="" class="padd"><strong data-v-7d9d14b5="" class="mb5">{{__('To')}}:</strong>
                                            @if(isset($user) && !empty($user))
                                                <p data-v-7d9d14b5="">{{$user->name}}</p>
                                                <pre data-v-7d9d14b5="">{{$user->email}}</pre>
                                            @else
                                                <p data-v-7d9d14b5="">-</p>
                                            @endif
                                        </div>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <table data-v-7d9d14b5="" class="summary-table">
                                            ...
                                            <tr data-v-7d9d14b5="">
                                                ...
                                                <td data-v-7d9d14b5="" class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-7d9d14b5="">
                                                <td data-v-7d9d14b5="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-7d9d14b5="" class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-7d9d14b5="" class="d-table">
                                    <div data-v-7d9d14b5="" class="d-table">
                                        <div data-v-7d9d14b5="" class="tu d-table-tr" style="color: {{$font_color}}; background: {{$color}};">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-th w-18" style="padding: 3px;">{{__('Item description')}}</div>
                                            <div data-v-7d9d14b5="" class="d-table-th w-4" style="padding: 3px;">{{__('Price')}}</div>
                                        </div>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-td w-18" style="padding: 3px;">
                                                            <pre data-v-7d9d14b5="">{{$item->iteam}}<br data-v-7d9d14b5=""></pre>
                                                        </div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-4" style="padding: 3px;"><span data-v-7d9d14b5="">{{$usr->priceFormat($item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-td w-4" style="padding: 3px;"><span data-v-7d9d14b5="">-</span></div>
                                                </div>
                                            @endif
                                        </div>
