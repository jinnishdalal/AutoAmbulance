                                ...
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><strong data-v-e23d9750="" class="tu mb5">{{__('Bill To')}}:</strong>
                                        @if(isset($user) && !empty($user))
                                            <p data-v-e23d9750="">{{$user->name}}</p>
                                            <pre data-v-e23d9750="">{{$user->email}}</pre>
                                        @else
                                            <p data-v-e23d9750="">-</p>
                                        @endif
                                    </div>
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr data-v-e23d9750="">
                                                ...
                                                <td data-v-e23d9750="" class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-e23d9750="">
                                                <td data-v-e23d9750="" class="tu fwb">{{__('Due Date')}}:</td>
                                                <td data-v-e23d9750="" class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-e23d9750="" class="d-table">
                                    <div data-v-e23d9750="" class="d-table">
                                        <div data-v-e23d9750="" class="tu d-table-tr" style="border-bottom: 2px solid {{$color}};">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-th w-18">{{__('Item description')}}</div>
                                            <div data-v-e23d9750="" class="d-table-th w-4">{{__('Price')}}</div>
                                        </div>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-18">
                                                            <pre data-v-e23d9750="">{{$item->iteam}}<br data-v-e23d9750=""></pre>
                                                        </div>
                                                        <div data-v-e23d9750="" class="d-table-td w-4"><span data-v-e23d9750="">{{$usr->priceFormat($item->price)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-e23d9750="" class="d-table-tr">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-td w-4"><span data-v-e23d9750="">-</span></div>
                                                </div>
                                            @endif
                                        </div>
