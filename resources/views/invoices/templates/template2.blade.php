                            ...
                            <div data-v-37eeda86="" class="d-inner">
                                ...
                                <div data-v-37eeda86="" class="row">
                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                                                                   style="color: {{$color}};">{{__('INVOICE')}}</strong>
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Issue Date')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Due Date')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        <div data-v-37eeda86="" class="tu d-table-tr" style="color: {{$color}}; border-bottom: 1px solid {{$color}}; border-top: 1px solid {{$color}};">
                                            <div class="d-table-th w-2">{{__('#')}}</div>
                                            <div class="d-table-th w-18">{{__('Item')}}</div>
                                                ...
                                                @foreach($invoice->items as $key => $item)
                                                    <div class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div class="d-table-td w-18">
                                                            <pre data-v-f2a183a6="">{{$item->iteam}}</pre>
                                                        </div>
