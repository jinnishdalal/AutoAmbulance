                                ...
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    ...
                                    <div data-v-f2a183a6="" class="d-header-50 d-right">
                                        ...
                                        <table data-v-f2a183a6="" class="summary-table">
                                            ...
                                            <tr>
                                                <td>{{__('Issue Date')}}:</td>
                                                <td>{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr>
                                                <td>{{__('Due Date')}}:</td>
                                                <td>{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                    ...
                                                    @foreach($invoice->items as $key => $item)
                                                        <div class="d-table-tr" style="border-bottom:1px solid {{$border_color}};">
                                                            ...
                                                            <div class="d-table-td w-18">
                                                                <span data-v-f2a183a6="">{{$item->iteam}}</span>
                                                            </div>
                                                            <div class="d-table-td w-4">
                                                                <span data-v-f2a183a6="">{{$usr->priceFormat($item->price)}}</span>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                @else
