                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('INVOICE')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{$invoice->project ? $invoice->project->name : '-'}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{\App\Utility::dateFormat($invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Due Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{\App\Utility::dateFormat($invoice->due_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div data-v-1ad6e3b9="" class="col-2">
                                            <div data-v-1ad6e3b9="" class="col-66">
                                                ...
                                                @if(isset($user) && !empty($user))
                                                    <strong data-v-1ad6e3b9="" class="sub-title">{{$user->name}}</strong>
                                                    <pre data-v-1ad6e3b9="">{{$user->email}}</pre>
                                                @else
                                                    <strong data-v-1ad6e3b9="" class="sub-title">-</strong>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-1ad6e3b9="" class="d-table">
                                        <div data-v-1ad6e3b9="" class="d-table">
                                            <div data-v-1ad6e3b9="" class="tu d-table-tr" style="background: {{$color}};color:{{$font_color}}">
                                                ...
                                                <div data-v-1ad6e3b9="" class="d-table-th w-18" style="padding: 5px;">{{__('Item description')}}</div>
                                                <div data-v-1ad6e3b9="" class="d-table-th w-4" style="padding: 5px;">{{__('Price')}}</div>
                                            </div>
                                                ...
                                                @if(isset($invoice->items) && count($invoice->items) > 0)
                                                    @foreach($invoice->items as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-2" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$key+1}}</span></div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-18" style="border: 1px solid {{$color}}; padding: 5px;">
                                                                <pre data-v-1ad6e3b9="">{{$item->iteam}}<br data-v-1ad6e3b9=""></pre>
                                                            </div>
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-4" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat($item->price)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
                                                        ...
                                                        <div data-v-1ad6e3b9="" class="d-table-td w-4" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">-</span></div>
                                                    </div>
                                                @endif
                                            </div>
