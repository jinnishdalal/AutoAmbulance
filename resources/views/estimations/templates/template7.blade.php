                                    ...
                                    <div data-v-1ad6e3b9="" class="col-33"><h1 data-v-1ad6e3b9="" class="fancy-title mb5">{{__('ESTIMATION')}}</h1> <br data-v-1ad6e3b9=""><br data-v-1ad6e3b9="">
                                        <table data-v-1ad6e3b9="" class="summary-table">
                                            ...
                                            <tr data-v-1ad6e3b9="">
                                                ...
                                                <td data-v-1ad6e3b9="" class="text-right">{{\App\Utility::estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-1ad6e3b9="">
                                                <td data-v-1ad6e3b9="" class="fwb">{{__('Issue Date')}}:</td>
                                                <td data-v-1ad6e3b9="" class="text-right">{{\App\Utility::dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                ...
                                                @if(isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                    @foreach($estimation->getProducts as $key => $item)
                                                        <div data-v-1ad6e3b9="" class="d-table-tr">
                                                            ...
                                                            <div data-v-1ad6e3b9="" class="d-table-td w-3 text-right" style="border: 1px solid {{$color}}; padding: 5px;"><span data-v-1ad6e3b9="">{{$usr->priceFormat($item->price * $item->quantity)}}</span></div>
                                                        </div>
                                                    @endforeach
                                                @else
                                                    <div data-v-1ad6e3b9="" class="d-table-tr">
