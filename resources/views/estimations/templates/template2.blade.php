                                    ...
                                    <div data-v-37eeda86="" class="col-33"><strong data-v-37eeda86="" class="tu mb5"
                                        ...
                                        <table data-v-37eeda86="" class="summary-table">
                                            ...
                                            <tr data-v-37eeda86="">
                                                ...
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\App\Utility::estimateNumberFormat($estimation->estimation_id)}}</td>
                                            </tr>
                                            <tr data-v-37eeda86="">
                                                <td data-v-37eeda86="" class="tu">{{__('Issue Date')}}:</td>
                                                <td data-v-37eeda86=""
                                                    class="text-right">{{\App\Utility::dateFormat($estimation->issue_date)}}</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                            ...
                                            @if(isset($estimation->getProducts) && count($estimation->getProducts) > 0)
                                                @foreach($estimation->getProducts as $key => $item)
                                                    <div class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div class="d-table-td w-4 text-right"><span>{{$usr->priceFormat($item->price * $item->quantity)}}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
