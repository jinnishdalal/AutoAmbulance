...
@section('action-button')
    <div class="all-button-box row d-flex justify-content-end">
        ...
        @can('manage bug report')
            <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                <a href="{{ route('task.bug',$project->id) }}" class="btn btn-xs btn-white btn-icon-only width-auto"><i class="fas fa-bug"></i> {{__('Bug List')}} </a>
            </div>
        @endcan
    </div>
@endsection
                                                ...
                                                <div class="col-12 pt-2">
                                                    <p class="mb-0">
                                                        <a href="#" class="btn btn-sm mr-1 p-0 rounded-circle">
                                                            <img alt="image" data-toggle="tooltip" data-original-title="{{(!empty($bug->task_user)?$bug->task_user->name:'')}}" src="{{(!empty($bug->task_user->avatar)? asset(Storage::url('avatar/'.$bug->task_user->avatar)) : asset(Storage::url('avatar/avatar.png')))}}" class="rounded-circle " width="25" height="25">
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
